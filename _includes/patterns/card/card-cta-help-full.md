    ...
    <li class="usa-card tablet:grid-col-4">
        <div class="callout__container__inv">
            ...
            <div class="callout__inv__body">
                ...
                <p>Child Welfare Information Gateway does not have the authority to intervene in personal matters. Please see our resources on<a href=""> finding help with a personal situation.</a></p>
            </div>
        </div>
    </li>
</ul>